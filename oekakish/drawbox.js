...
*/
const GOOGLE_FORM_ID = "1FAIpQLSe3jTCQr9sXF2mKS_6g5klpLAH1xuUIvkmBYTgmonuKLCYzAw";
const ENTRY_ID = "entry.757141417";
const GOOGLE_SHEET_ID = "1BYAUVUkH4DH9mGyoEIlgTNKSSgdqwB3hlFTf7cwu3U8";
  ...
  try {
    ...
    rows.reverse().forEach((row) => {
      ...
      if (imgUrl.startsWith("http")) {
        ...
        div.innerHTML = `
                    <a href="${imgUrl}" target="_blank"><img src="${imgUrl}" alt="drawing"></a>
                    <p>${timestamp}</p>
                `;
